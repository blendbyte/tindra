...
func TestSetLimits_updatesLimitsAtRuntime(t *testing.T) {
	h := api.NewRouter(testPool, ingest.NewBuffer(1), nil, nil, nil, nil, nil, false, "", "", "test-stats-key", "", 0, 0, 0, 0, 0, 0, nil, false, true, nil)
...
func TestSetLimits_zeroDisablesLimit(t *testing.T) {
	...
	h := api.NewRouter(testPool, ingest.NewBuffer(1), nil, nil, nil, nil, nil, false, "", "", "test-stats-key", "", 0, 0, 999, 0, 0, 0, nil, false, true, nil)
...
func TestWriteJSONStatus_viaStatsEndpoint(t *testing.T) {
	h := api.NewRouter(testPool, ingest.NewBuffer(1), nil, nil, nil, nil, nil, false, "", "", "my-stats-key", "", 0, 0, 0, 0, 0, 0, nil, false, true, nil)
